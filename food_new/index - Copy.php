...
?>
    ...
    <div class="container margin_60">
        ...
        <?php 
        $sql="SELECT * FROM food_vendors WHERE `lkp_status_id`= '0' AND lkp_city_id = 1 AND id IN (SELECT restaurant_id FROM food_products WHERE lkp_status_id = 0) ORDER BY id DESC LIMIT 0,4 ";
        $getMostPopualrRest = $conn->query($sql); ?>
