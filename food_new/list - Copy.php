    ...
    <div id="position">
        <div class="container">
            <ul>
                ...
                <?php 
                $getLocation = getIndividualDetails('food_vendors','restaurant_address',$_POST['searchKey']);
                $getLoactionName = getIndividualDetails('lkp_cities','id',$getLocation['lkp_city_id']);
                $_SESSION['city'] = $getLocation['lkp_city_id'];
                ?>               
                <li><?php if(isset($_POST['searchKey'])) { ?><?php echo $getLoactionName['city_name']; ?><?php } else { ?>Restaurants<?php } ?></li>
            </ul>
