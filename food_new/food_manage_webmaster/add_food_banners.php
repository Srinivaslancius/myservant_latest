...
if (!isset($_POST['submit'])) {
    ...
    if($_FILES["fileToUpload"]["name"]!='') {
              ...
              if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                    $sql = "UPDATE `food_banners` SET title = '$title',banner = '$fileToUpload', lkp_status_id='$lkp_status_id' WHERE id = '$id' ";
          ...
          $sql = "UPDATE `food_banners` SET title = '$title', lkp_status_id='$lkp_status_id' WHERE id = '$id' ";
          if($conn->query($sql) === TRUE){
             echo "<script type='text/javascript'>window.location='food_banners.php?msg=success'</script>";
          } else {
             echo "<script type='text/javascript'>window.location='food_banners.php?msg=fail'</script>";
