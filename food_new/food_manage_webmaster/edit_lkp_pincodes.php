              ...
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <select name="lkp_state_id" class="custom-select chosen" data-plugin="select2" data-options="{ placeholder: 'Select a State', allowClear: true }" data-error="This field is required." required onChange="getDistricts(this.value);">
