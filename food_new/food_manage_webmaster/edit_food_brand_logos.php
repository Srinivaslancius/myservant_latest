...
if (!isset($_POST['submit'])) {
    ...
    if($_FILES["fileToUpload"]["name"]!='') {
              ...
              $fileToUpload = $_FILES["fileToUpload"]["name"];
              $target_dir = "../../uploads/food_brand_logos/";
              $target_file = $target_dir . basename($_FILES["fileToUpload"]["name"]);
              $imageFileType = pathinfo($target_file,PATHINFO_EXTENSION);
              $getImgUnlink = getImageUnlink('brand_logo','food_brand_logos','id',$id,$target_dir);
                //Send parameters for img val,tablename,clause,id,imgpath for image ubnlink from folder
              if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                    $sql = "UPDATE food_brand_logos SET title = '$title',brand_logo = '$fileToUpload', lkp_status_id='$lkp_status_id' WHERE id = '$id' ";
                    if($conn->query($sql) === TRUE){
                       echo "<script type='text/javascript'>window.location='food_brand_logos.php?msg=success'</script>";
                    } else {
                       echo "<script type='text/javascript'>window.location='food_brand_logos.php?msg=fail'</script>";
                    }
      ...
      <div class="site-content">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="m-y-0">Food Brand Logos</h3>
          </div>
          <div class="panel-body">            
            <div class="row">
              <?php $getBrandLogos = getAllDataWhere('food_brand_logos','id',$id);
              ...
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <img src="<?php echo $base_url . 'uploads/food_brand_logos/'.$getBrandLogosData['brand_logo'] ?>"  id="output" height="100" width="100"/>
