              ...
              <table class="table table-striped table-bordered dataTable" id="table-1">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td> <a href="edit_food_product_weights.php?wid=<?php echo $row['id']; ?>"><i class="zmdi zmdi-edit"></i></a>&nbsp; <a href="delete_food_product_weights.php?wid=<?php echo $row['id']; ?>"><i class="zmdi zmdi-delete zmdi-hc-fw" onclick="return confirm('Are you sure you want to delete?')"></i></a></td>                    
                  </tr>
                  <?php  $i++; }?>
                </tbody>
              </table>
