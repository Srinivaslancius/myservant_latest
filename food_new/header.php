    ...
    <div class="row myservant_topheader">
        ...
        <div class="row myseranr_header">
            ...
            <div class="col-md-1 col-xs-3" style="margin-top:3px">
                <a href="cart.php"><button type="button" class="btn btn-danger cart" style="background-color:transparent;border-color:white"><span class=" icon-cart" style="font-size:18px"></span> <span class="badge" style="font-size:10px" id="cart_cnt">(<?php echo $cartItems->num_rows; ?>)</span></button></a>
