                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <input type="text" name="weight_type" class="form-control" id="user_input" placeholder="Weight Type"  data-error="Please enter Weight Type" required onkeyup="checkUserAvailTest()" value="<?php echo $getGroceryWeights['weight_type'];?>">
