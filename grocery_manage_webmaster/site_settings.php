                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <input type="text" name="admin_title" class="form-control" id="form-control-3" placeholder="Enter Site Title" value="<?php echo $getGrocerySiteSettings['admin_title'];?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="form-control-3" class="col-sm-3 col-md-4 control-label">Meta Title</label>
                                <div class="col-sm-6 col-md-4">
                                    <input type="text" name="meta_title" class="form-control" id="form-control-3" placeholder="Enter Meta Title" required value="<?php echo $getGrocerySiteSettings['meta_title'];?>">
                                </div>
                            </div>
                            <div class="form-group">
