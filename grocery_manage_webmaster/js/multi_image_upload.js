...
//To add new input file field dynamically, on click of "Add More Files" button below function will be executed
    ...
    /*$('#add_more1').click(function() {
        $(this).before($("<div/>", {id: 'filediv'}).fadeIn('slow').append(
                $("<input/>", {name: 'fileToUpload1[]', type: 'file', id: 'file', accept: 'image/*'}),        
                $("<br/><br/>")
                ));
    });*/

     /*$('#add_more_floor_plans').click(function() {
        $(this).before($("<div/>", {id: 'filediv_floor_plan'}).fadeIn('slow').append(
                $("<input/>", {name: 'floor_plan_images[]', type: 'file', id: 'file', accept: 'image/*'}),        
                $("<br/><br/>")
                ));
    });
*/
