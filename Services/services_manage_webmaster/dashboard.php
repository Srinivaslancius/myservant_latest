    ...
    <div class="site-main">
      <div class="site-content">
        <div class="row">
          ...
          <a href="services_group_service_names.php">
          <div class="col-md-4 col-sm-5">
            <div class="widget widget-tile-2 bg-primary m-b-30">
              <div class="wt-content p-a-20 p-b-50">
                <div class="wt-title">Services</div>
                <div class="wt-number"><?php echo getRowsCount('services_group_service_names')?></div>
              </div>
              <div class="wt-icon">
                <i class="zmdi zmdi-accounts"></i>
              </div>
        ...
        <div class="col-md-4">
            <div class="panel panel-default">
              ...
              <?php $getIosUsers = "SELECT * FROM users WHERE lkp_register_device_type_id = 3 AND lkp_admin_service_type_id = 1";
              $getIosUsers1 = $conn->query($getIosUsers);
              $getIosUsersCount = $getIosUsers1->num_rows; ?>
              <?php $getWindowsUsers = "SELECT * FROM users WHERE lkp_register_device_type_id = 1 AND lkp_admin_service_type_id = 1";
          ...
          <div class="col-md-4">
            <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h3 class="panel-title">Top Orders</h3>
            ...
            <div class="panel panel-default panel-table">
              ...
              <div class="table-responsive">
                <table class="table table-hover">
                  ...
                  <tbody>
                    <?php while($getTotalOrders = $getServiceOrderData->fetch_assoc()) { ?>
                    <tr>
                      <td>
                        <?php echo $i;?>
                      </td>
...
<script>
    function createChart(id, type, options) {
      var data = {
        labels: [ <?php $getOrders =  $conn->query("SELECT * FROM services_orders GROUP BY category_id");
          while ($getOrdersData = $getOrders->fetch_assoc()) {
            $category_id1 = $getOrdersData['category_id']; 
            $getCategoriesNames = $conn->query("SELECT * FROM services_category WHERE id = '$category_id1'");
            $getCategoriesNames1 = $getCategoriesNames->fetch_assoc();
            echo "'".$getCategoriesNames1['category_name'] . "'".','; } ?> ],
        datasets: [
          {
            label: 'My First dataset',
            data: [<?php $getOrders1 =  $conn->query("SELECT * FROM services_orders GROUP BY category_id");
                        while ($getOrdersCount = $getOrders1->fetch_assoc()) {
                          $category_id = $getOrdersCount['category_id']; 
                          $getCategories1 = $conn->query("SELECT * FROM services_orders WHERE category_id = '$category_id'");
