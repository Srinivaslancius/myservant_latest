...
<ul id="cat_nav">
       ...
       <li><a href="service_orders.php" class="<?php if($page_name == 'service_orders.php' || $page_name == 'services_category_orders.php') { echo "active"; } ?>"><i class="icon-cart"></i> Services Orders</a></li>
       <li><a href="../food_new/food_orders1.php" class="<?php if($page_name == 'food_orders1.php' || $page_name == 'order_details1.php') { echo "active"; } ?>"><i class="icon-food-1"></i> Food Orders</a></li>
