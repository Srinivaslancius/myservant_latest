...
<ul id="cat_nav">
       ...
       <li><a href="../food_new/food_orders1.php" class="<?php if($page_name == '../food_new/food_orders1.php.php' || $page_name == '../food_new/order_details1.php') { echo "active"; } ?>"><i class="icon-food-1"></i> Food Orders</a></li>
