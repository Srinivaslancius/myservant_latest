                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <select id="type" name="type" class="form-control" data-plugin="select2" data-options="{ theme: bootstrap }" required>
                                        ...
                                        <?php $getTypes = getAllDataWithStatus('banner_types','0');?>
                        ...
                        <table class="table table-striped table-bordered dataTable" id="table-2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <a href="edit_grocery_banners.php?brand_id=<?php echo $row['id']; ?>"><i class="zmdi zmdi-edit"></i></a> &nbsp; <!-- <a href="delete.php?id=<?php echo $row['id']; ?>&table=<?php echo "grocery_banners" ?>"><i class="zmdi zmdi-delete zmdi-hc-fw" onclick="return confirm('Are you sure you want to delete?')"></i></a> --></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
