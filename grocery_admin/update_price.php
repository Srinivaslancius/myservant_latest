                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="btn-group col-sm-6 col-md-4" >
                                             <label class="btn btn-outline-primary">
                                                <input type="radio" name="buttonRadios[]" required onclick="check_offer(1)" value='1' hidden> Yes
                                            </label>
                                            <label class="btn btn-outline-primary">
                                                <input type="radio" name="buttonRadios[]" required onclick="check_offer(0)" value='0' hidden> No &nbsp;
                                            </label>
                                        </div>
                                    </div> 
