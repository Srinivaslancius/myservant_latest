        ...
        <div class="site-content">
            <div class="panel panel-default">
                        ...
                        <form class="form-horizontal" method="POST" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <textarea id="form-control-8" class="form-control" rows="3" name="testimonial" required="required"></textarea>
                                </div>
                            </div>
             ...
             <div class="panel panel-default panel-table m-b-0">
                <div class="panel-heading">
                    <h3 class="m-t-0 m-b-5 font_sz_view">View Testimonials</h3>
                        ...
                        <table class="table table-striped table-bordered dataTable" id="table-2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo $base_url . 'uploads/grocery_testimonials/'.$row['image']; ?>"  id="output" height="60" width="60"/></td>
