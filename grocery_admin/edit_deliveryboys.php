                    ...
                    <div class="row">
                        ...
                        <form class="form-horizontal" method="POST" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <input type="email"  name="deliveryboy_email" class="form-control" id="form-control-3" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,63}$" placeholder="Enter Email"  required="required" value="<?php echo $getGrcTest['deliveryboy_email'];?>">
                                </div>
                            </div>
                            <div class="form-group">
