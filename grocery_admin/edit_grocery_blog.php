        ...
        if (!isset($_POST['submit']))  {
          echo "fail";
            ...
            if($_FILES["image"]["name"]!='') {
                ...
                $sql = "UPDATE `grocery_blog` SET title = '$title', image = '$image', name = '$name',editor='$editor', lkp_status_id = '$lkp_status_id' WHERE id = '$cid' ";
            } else {

                $sql = "UPDATE `grocery_blog` SET title = '$title', name = '$name',editor='$editor', lkp_status_id = '$lkp_status_id' WHERE id = '$cid' ";
            }
        ...
        <div class="site-content">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <?php $getGrcTest = getIndividualDetails('grocery_blog','id',$cid); ?>
                        <form class="form-horizontal" method="POST" autocomplete="off" enctype="multipart/form-data">
                             <div class="form-group">
                                <label class="col-sm-3 col-md-4 control-label" for="form-control-3">Title</label>
                                <div class="col-sm-6 col-md-4">
                                    <input type="text" name="title" class="form-control" id="form-control-3" placeholder="Enter Title" required value="<?php echo $getGrcTest['title']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <input type="text" class="form-control" id="form-control-3" placeholder="Enter Editor" name="editor" required="required" value="<?php echo $getGrcTest['editor']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <img src="<?php echo $base_url . 'grocery_admin/uploads/grocery_blog/'.$getGrcTest['image']; ?>"  id="output" height="100" width="100"/>
                                <?php } ?>
