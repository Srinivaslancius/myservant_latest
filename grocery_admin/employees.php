        ...
        if (!isset($_POST['submit']))  {
          echo "fail";
            ...
            if($_FILES["image"]["name"]!='') {
                ...
                $sql = "INSERT INTO grocery_employess (`employee_name`,`employee_mobile`,`employee_email`,`identity_proof_image`, `lkp_status_id`) VALUES ('$employee_name', '$employee_mobile', '$employee_email','$image','$lkp_status_id')";
            } 
        ...
        <div class="site-content">
            <div class="panel panel-default">
                        ...
                        <form class="form-horizontal" method="POST" autocomplete="off" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <input type="text" name="employee_name" class="form-control" id="form-control-3" placeholder="Enter Name"  required="required">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="form-control-3" class="col-sm-3 col-md-4 control-label">Email</label>
                                <div class="col-sm-6 col-md-4">
                                    <input type="email"  name="employee_email" class="form-control" id="form-control-3" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,63}$" placeholder="Enter Email"  required="required">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <input type="text" name="employee_mobile" class="form-control" id="form-control-3" placeholder="Enter Mobile"  required="required" onkeypress="return isNumberKey(event)" maxlength="10" pattern="[0-9]{10}">
                                </div>
                            </div>
                            <div class="form-group">
             ...
             <div class="panel panel-default panel-table m-b-0">
                <div class="panel-heading">
                    <h3 class="m-t-0 m-b-5 font_sz_view">View Employees</h3>
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered dataTable" id="table-2">
                            ...
                            <tbody>
                                <?php $getEmployees = getAllDataWithActiveRecent('grocery_employess'); $i=1; ?>
