        ...
        <div class="site-content">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="m-y-0 font_sz_view">Edit Areas</h3>
                </div>
                    ...
                    <div class="row">
                        ...
                        <form class="form-horizontal" method="POST" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <select id="form-control-1" name="lkp_state_id" class="form-control" data-plugin="select2" data-options="{ theme: bootstrap }" required onChange="getDistricts(this.value);">
                                      ...
                                      <?php while($row = $getStates->fetch_assoc()) {  ?>
                                          <option <?php if($row['id'] == $getAreas['lkp_state_id']) { echo "Selected"; } ?> value="<?php echo $row['id']; ?>"><?php echo $row['state_name']; ?></option>
                                      <?php } ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <select name="lkp_district_id" id="lkp_district_id" class="form-control" data-plugin="select2" data-options="{ theme: bootstrap }" required onChange="getCities(this.value);">
                                      ...
                                      <?php while($row = $getDistrictsData->fetch_assoc()) {  ?>
                                          <option <?php if($row['id'] == $getAreas['lkp_district_id']) { echo "Selected"; } ?> value="<?php echo $row['id']; ?>"><?php echo $row['district_name']; ?></option>
                                      <?php } ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <select name="lkp_city_id" id="lkp_city_id" class="form-control" data-plugin="select2" data-options="{ theme: bootstrap }" required onChange="getPincodes(this.value);">
                                      ...
                                      <?php while($row = $getCities->fetch_assoc()) {  ?>
                                          <option <?php if($row['id'] == $getAreas['lkp_city_id']) { echo "Selected"; } ?> value="<?php echo $row['id']; ?>"><?php echo $row['city_name']; ?></option>
                                      <?php } ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <select name="lkp_pincode_id" id="lkp_pincode_id" class="form-control" data-plugin="select2" data-options="{ theme: bootstrap }" required>
                                      ...
                                      <?php while($row = $getPincodes->fetch_assoc()) {  ?>
                                          <option <?php if($row['id'] == $getAreas['lkp_pincode_id']) { echo "Selected"; } ?> value="<?php echo $row['id']; ?>"><?php echo $row['pincode']; ?></option>
                                      <?php } ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <input type="text" class="form-control" id="form-control-3" placeholder="Enter Area" name="area_name" required value="<?php echo $getAreas['area_name']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
