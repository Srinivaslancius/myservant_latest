        ...
        <div class="site-content">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="m-y-0 font_sz_view">Add Districts</h3>
                </div>
                    ...
                    <div class="row">
                        ...
                        <form class="form-horizontal" method="post" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <input type="text" name="district_name[]" class="form-control" id="form-control-3" placeholder="Enter District Name" required>
                                </div>
            ...
            <div class="panel panel-default panel-table m-b-0">
                <div class="panel-heading">
                    <h3 class="m-t-0 m-b-5 font_sz_view">View Districts</h3>
