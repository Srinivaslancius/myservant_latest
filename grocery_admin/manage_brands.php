                        ...
                        <table class="table table-striped table-bordered dataTable" id="table-2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo $base_url . 'grocery_admin/uploads/grocery_brands_web_logo/'.$row['web_logo'] ?>" width="100" height="100"></td>
                                    <td><img src="<?php echo $base_url . 'grocery_admin/uploads/grocery_brands_app_logo/'.$row['app_logo'] ?>" width="100" height="100"></td>
                                    ...
                                    <td> <a href="edit_grocery_brands.php?brand_id=<?php echo $row['id']; ?>"><i class="zmdi zmdi-edit"></i></a> &nbsp; <!-- <a href="delete.php?id=<?php echo $row['id']; ?>&table=<?php echo "grocery_brands" ?>"><i class="zmdi zmdi-delete zmdi-hc-fw" onclick="return confirm('Are you sure you want to delete?')"></i></a> --></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
