    ...
    <script>
        ...
        $('.add_more_button').click(function(e){ //click event on add more fields button having class add_more_button
            ...
            if(x < max_fields_limit){ //check conditions
                x++; //counter increment
                $('.input_fields_container').append('<div><div class="form-group"><label class="col-sm-3 control-label" for="form-control-9">Area Name</label><div class="col-sm-6 col-md-4"><input type="text" name="area_name[]" class="form-control" id="user_input" placeholder="Enter Area Name" required></div><a href="#" class="remove_field btn btn-warning"style="margin-left:15px"><i class="zmdi zmdi-minus-circle zmdi-hc-fw"></i></a></div></div>'); //add input field
            }
        });  
